...
if __name__ == "config":
    ...
    greedy = gen_greedy_surveys(nside, nexp=2, nexp_override=nexp_override,
                                exptime_override=exptime_override, exptime=29.2,
                                filters=eo_test_filters, footprints=footprints, seed=seed)
    surveys = [greedy]
